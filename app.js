...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todoListViewModel = __webpack_require__(19);

	var _knockout = __webpack_require__(20);

	var ko = _interopRequireWildcard(_knockout);

	var _todosRepository = __webpack_require__(24);

	var _exportsPagerImports$JqueryKoKnockoutPagerjs = __webpack_require__(25);

	var pager = _interopRequireWildcard(_exportsPagerImports$JqueryKoKnockoutPagerjs);

	function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

	var list = _todosRepository.todosRepository.load();
	var viewModel = new _todoListViewModel.ViewModel(list);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todoModel = __webpack_require__(23);
	...
	var ViewModel = exports.ViewModel = function () {
	    function ViewModel(list) {
	        ...
	        this.itemsLeftCount = ko.computed(function () {
	            return _this.todoList().filter(function (element) {
	    ...
	    _createClass(ViewModel, [{
	        key: 'toggleChecking',
	        value: function toggleChecking(todo) {
	            todo.checked(!todo.checked());
	            this.saveState();
	        }
	    }, {
	        key: 'handleKeyUp',
	        value: function handleKeyUp(todo, event) {
	            var ENTER_KEY_CODE = 13;
	            var ESCAPE_KEY_CODE = 27;

	            if (event.keyCode === ENTER_KEY_CODE && this.inputText()) {
	                var text = this.inputText();
	                var _todo = new _todoModel.Todo(text);
	                this.todoList.unshift(_todo);
	                this.inputText('');
	                this.saveState();
	            }
	        ...
	        key: 'getItemsLeftText',
	        value: function getItemsLeftText() {
	            var count = this.itemsLeftCount();
	            var ext = count === 1 ? '' : 's';

	            return count + ' item' + ext + ' left';
	        }
	    }, {
	        key: 'getDisplayedTodos',
	        value: function getDisplayedTodos() {
	            var current = this.mode();
	            var todoItems = this.todoList();
	        ...
	        value: function saveState() {
	            _todosRepository.todosRepository.save(this.todoList);
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Todo = exports.Todo = function Todo(value) {
	    var _this = this;
	    ...
	    this.unchecked = ko.computed(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.todosRepository = undefined;
	...
	var localStorageItemName = 'todoList';

	var todosRepository = exports.todosRepository = {
	    load: function load() {
	        var list = JSON.parse(window.localStorage.getItem(localStorageItemName)) || [];
	        return list.map(function (todo) {
	            return new _todoModel.Todo(todo.value, todo.checked);
	        });
	    },
	    save: function save(uploadedList) {
	        var list = ko.toJS(uploadedList);
